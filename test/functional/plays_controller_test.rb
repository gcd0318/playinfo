...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { added_by: @play.added_by, name: @play.name, theater_id: @play.theater_id, verified_by: @play.verified_by }
    end
  ...
  test "should update play" do
    put :update, id: @play, play: { added_by: @play.added_by, name: @play.name, theater_id: @play.theater_id, verified_by: @play.verified_by }
    assert_redirected_to play_path(assigns(:play))
  end
