...
class TheatersControllerTest < ActionController::TestCase
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post :create, theater: { address: @theater.address, city: @theater.city, email: @theater.email, name: @theater.name, tel: @theater.tel, weibo: @theater.weibo }
    end
  ...
  test "should update theater" do
    put :update, id: @theater, theater: { address: @theater.address, city: @theater.city, email: @theater.email, name: @theater.name, tel: @theater.tel, weibo: @theater.weibo }
    assert_redirected_to theater_path(assigns(:theater))
  end
